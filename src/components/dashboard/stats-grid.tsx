            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center gap-1 mt-2">
                  <span className={stat.trend.startsWith('+') ? "text-emerald-600 text-[10px] font-black" : "text-slate-400 text-[10px] font-black"}>
                    {stat.trend}
                  </span>
                  <span className="text-[10px] text-muted-foreground ml-1">en temps réel</span>
                </div>
              </div>
